...
function ViewNapGarena({loggedIn}) {
        ...
        if(loggedIn){
            return(
                <Grid className={classes.root}>
                    <Container maxWidth="md" className={classes.container_viewnapgarena}>
                        <Grid>
...
export default connect(mapStateToProps, null)(ViewNapGarena)